        ...
        <div className="max-w-7xl mx-auto w-full z-10 mt-20">
          ...
          <div className="block lg:hidden">
            ...
            >
              ...
              <motion.div variants={imageVariants} className="mb-8">
                <div className="w-32 h-32 mx-auto relative">
                  ...
                  <motion.div
                    ...
                    className="absolute -inset-2 rounded-2xl border border-blue-500/50"
                  />
                </div>
              </motion.div>
              ...
              >
                I build robust, end-to-end web applications with modern full-stack technologies, 
                delivering seamless user experiences from frontend to backend.
              </motion.p>
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-blue-500 font-medium">ROHAN</span>
                <br />
                <span className={isDarkMode ? "text-white" : "text-gray-900"}>
                  SOMASHEKHAR ANKAD
                </span>
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="absolute -inset-4 rounded-3xl border border-blue-500/50"
                />
                <motion.div
                  animate={{ rotate: -360 }}
                  transition={{
